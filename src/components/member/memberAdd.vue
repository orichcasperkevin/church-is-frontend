                ...
                <div v-if="add_member_error.length > 0 "role="alert">
                        ...
                        <section class="mx-auto col-lg-8 col-sm-12" v-if = "form_in_view == 'marital_status_form'">
                                ...
                                <div class="ml-2 d-flex justify-content-end">
                                        ...
                                        <button class="ml-2 btn btn-outline-success"
                                                @click="form_in_view = 'residence_form'">
                                        next
                                        </button>
                                </div>
                        </section>                                                       
                        ...
                        <section class="mx-auto col-lg-8 col-sm-12" v-if = "form_in_view == 'residence_form'">
                         ...
                         <section class="mx-auto col-lg-8 col-sm-12" v-if = "form_in_view == 'groups_form' ">
                                <!-- head -->
                                <div class="ml-0 mb-3">
                                        <a  style="cursor: pointer" class="text-primary" @click="form_in_view = 'residence_form'">
                                                <img style="height: 20px" src="@/assets/icons/icons8-back-filled-50.png" alt="back">
                                                back
                                        </a>
                                        <h4 class="mt-3 text-muted">groups for {{added_member[0].member.first_name}} {{added_member[0].member.last_name}}</h4>                                  
                                </div>
                                <!-- group input -->
                                <div v-if="! groups_added_into.length" class="col">                                      
                                        <label><b>select groups :</b></label>                                        
                                        <label v-for = "data in groups.response" class="anvil-checkbox">
                                                <input multiple type="checkbox" :value=data.id v-model="group_ids">
                                                <span class="anvil-checkmark"></span>
                                                <span class="ml-5">{{data.name}}</span>
                                        </label>
                                </div>                               
